...
public class Poised {
    ...
    public static Project newProject() {
        ...
        // store it in different attributes.
        ...
        int newErfNumber = questions.nextInt();

        questions = new Scanner(System.in);
        System.out.println("Enter the total project fee here:\n");
        double newTotalProjectFee = questions.nextDouble();
        ...
        return new Project(newProjectNumber, newProjectName, newBuildingType, newProjectAddress,
